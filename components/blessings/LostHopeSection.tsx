...
export const LostHopeSection: React.FC = () => {
    // ... existing component code (omitted for brevity, no changes needed in logic) ...
    ...
    const getSigilDisplayInfo = (sigil: LostHopeSigil): { color: SigilColor, benefits: React.ReactNode } => {
        ...
        const benefits = (
            <>
                {sigil.benefits.channeling ? <p className="text-orange-300">+ {sigil.benefits.channeling} Channelling</p> : null}
                {sigil.benefits.necromancy ? <p className="text-gray-300">+ {sigil.benefits.necromancy} Necromancy</p> : null}
                {sigil.benefits.blackMagic ? <p className="text-purple-300">+ {sigil.benefits.blackMagic} Black Magic</p> : null}
            </>
        );
    ...
    const boostDescriptions: { [key: string]: string } = {
        spirit_medium: "Can briefly physically manifest spirits to aid you.",
        fata_morgana_curse: "Curse is twice as powerful and hard to remove.",
        spectral_form: "Can cast spells while in spectral form.",
        life_drain: "Drain is twice as fast.",
        undead_beast: "+10 Beast Points.",
        rise_from_your_graves: "Zombies are faster and stronger.",
        grasping_dead: "Hands are twice as strong and hard to escape.",
        the_moon_samurai: "Samurai are stronger and last longer.",
        undead_thrall: "+10 Companion Points.",
        vampirism: "Double duration of stolen spells.",
        cursemakers_cookbook: "Curses are permanent.",
        flowers_of_blood: "Regeneration is faster."
    };
                            ...
                            >
                                ...
                                {isUndeadBeast && isSelected && undeadBeastName && (
                                    <div className="text-center mt-2 pt-2 border-t border-gray-700/50">
                                        <p className="text-xs text-gray-400">Assigned Beast:</p>
                    ...
                    >
                        <div className="flex items-center justify-center gap-4">
                            ...
                            <div className="text-left">
                                ...
                                {ctx.blackMagicBoostSigil === 'xuth' && <p className="text-xs text-gray-400 mt-1">Switch to consume Sinthru sigil.</p>}
                            </div>
                        </div>
                    </div>
                    ...
                    >
                        <div className="flex items-center justify-center gap-4">
                            ...
                            <div className="text-left">
                                ...
                                {ctx.blackMagicBoostSigil === 'sinthru' && <p className="text-xs text-gray-400 mt-1">Switch to consume Xuth sigil.</p>}
                            </div>
                        </div>
                    </div>
                </div>
