...
export const BLESSING_ENGRAVINGS: ChoiceItem[] = [
    { id: 'skin', title: 'SKIN', cost: 'Costs 0 FP', description: "Not a very pleasant process, getting these sigils etched onto your bare skin... but what are you gonna do? At least the Blessing can't be taken away, unless that part of your body is chopped off. However, this is required for Blessings affected by the trait {w}Magician{/w}.", imageSrc: '/images/N68jJM5s-where1.webp' },
    { id: 'clothes', title: 'CLOTHES', cost: 'Costs 0 FP', description: "Probably the simplest option: have it emblazoned on your dress! The dress that comes with your alter ego is massively strengthened compared to normal fabric, but still, if it's torn or stolen, you'll lose the blessing until you can get it repaired or replaced.", imageSrc: '/images/W4yFYW8w-where2.webp' },
    { id: 'weapon', title: 'WEAPON', cost: 'Costs 0 FP', description: "A weapon will grant you {w}20 Weapon Points{/w} on the {i}Reference Page{/i}. Carving a Blessing onto a weapon will grant a {bp}1 BP{/bp} refund on its {j}Juathas{/j} sigil. However, in the 'Engrave this Blessing' section, choosing a 'new' weapon costs {fp}5 FP{/fp}. The power will be limited to the weapon and useless if you are disarmed.", imageSrc: '/images/tPJVNydk-where3.webp' },
];

export const BLESSING_ENGRAVINGS_KO: ChoiceItem[] = [
    { id: 'skin', title: '피부', cost: '행운 점수 0', description: "맨살에 표식을 새긴다니, 딱히 기분 좋은 과정은 아닙니다. 하지만... 이미 선택했잖아요? 적어도 표식을 새긴 부위가 떨어져나가지 않는 한 축복을 사용하지 못할 일은 없을 겁니다. {w}마법사{/w} 특성으로 선택한 축복이 있다면, 반드시 그 표식은 피부에 새겨야 합니다.", imageSrc: '/images/N68jJM5s-where1.webp' },
    { id: 'clothes', title: '의복', cost: '행운 점수 0', description: "제일 간단한 방법이죠. 드레스에 문양을 남기는 겁니다! 당신의 겉보기 자아에 딸려오는 드레스는 일반적인 옷보다 훨씬 튼튼하지만, 그래도 도둑맞거나 찢어지거나 한다면 옷을 교체하거나 수선하기 전까지 축복을 잃어버릴 겁니다.", imageSrc: '/images/W4yFYW8w-where2.webp' },
    { id: 'weapon', title: '무기', cost: '행운 점수 0', description: "새로운 무기를 적용하는 데에는 {fp}행운 점수 5점{/fp}이 필요합니다. {w}20 무기 점수{/w}가 주어지고, {i}참고 페이지{/i}에서 무기를 디자인할 수 있습니다. 표식을 무기에 새긴다면, {j}자타스{/j} 표식에 소모되는 {bp}축복 점수{/bp}를 1점 환급받을 수 있습니다. 하지만, 능력이 무기에 묶이기 때문에 당신이 무장해제당한다면 능력을 사용할 수 없을 겁니다.", imageSrc: '/images/tPJVNydk-where3.webp' },
];

export const COMMON_SIGILS_DATA: Sigil[] = [
  { id: 'kaarn', title: 'KAARN', cost: 'Costs 3 BP', imageSrc: '/images/zTm8fcLb-kaarn.webp', description: "Named after a mage whose village was terrorized by a despotic Sinubih archmage. The archmage was technically more magically powerful, yet was overthrown with creative use of insect telepathy. The tale's moral? Never underestimate seemingly 'weak' magic." },
  { id: 'purth', title: 'PURTH', cost: 'Costs 5 BP', imageSrc: '/images/Dg6nz0R1-purth.webp', description: "These represent breakthroughs in your understanding of a Blessing, as you unlock power that you didn't even know you had in you. For an average mage, this is about the greatest sort of power they'd acquire, with, perhaps, a single Xuth sigil of some sort." },
  { id: 'juathas', title: 'JUATHAS', cost: 'Costs 8 BP', imageSrc: '/images/SFbsP2R-juathas.webp', description: "The most renowned and famous sigil, for it implies the attainment of a brand new blessing. One becomes worthy of them either throw acts of great valor, impressing one of the Daughters, or, of course, training for long periods to unlock one's innate potential." },
];

export const COMMON_SIGILS_DATA_KO: Sigil[] = [
  { id: 'kaarn', title: '카른', cost: '축복 점수 3점', imageSrc: '/images/zTm8fcLb-kaarn.webp', description: "폭압적인 시누비 대마법사의 손아귀에 마을이 공포에 떨고 있을 때 나선 마녀의 이름이 붙은 표식입니다. 대마법사 쪽이 마력도 기술도 월등했지만, 곤충 텔레파시를 창의적으로 이용해서 격퇴할 수 있었습니다. 교훈이 뭐냐구요? '약해' 보이는 마법도 무시하면 안 된다는 겁니다." },
  { id: 'purth', title: '퍼르스', cost: '축복 점수 5점', imageSrc: '/images/Dg6nz0R1-purth.webp', description: "이 표식은 당신이 축복을 한 차원 더 높게 이해하게 되었고, 그에 따라 가지고 있는지도 몰랐던 힘을 해방하게 되었음을 의미합니다. 평균적인 마법소녀에게는 이 정도의 힘이 최대한의 전력일 것입니다. 뭐, 거기에 주스 표식 하나 정도 추가할 수는 있겠죠." },
  { id: 'juathas', title: '자타스', cost: '축복 점수 8점', imageSrc: '/images/SFbsP2R-juathas.webp', description: "가장 이름값 높은 표식입니다. 새로운 축복을 얻게 되었음을 나타내기 때문이지요. 대단한 용기를 보이거나, 어머니의 딸들 중 하나에게 깊은 인상을 남기거나, 수많은 훈련을 통해 개인의 잠재력을 개화시킨 이들만이 이 표식을 얻을 수 있습니다." },
];
...
export const SPECIAL_SIGILS_DATA: Sigil[] = [
  { 
    ...
    imageSrc: '/images/rfs5FtF3-xuth.webp', 
  ...
  { 
    ...
    imageSrc: '/images/DD9xYmP9-lekolu.webp', 
  ...
  { 
    ...
    imageSrc: '/images/nq80Y3pk-sinthru.webp', 
...
export const SPECIAL_SIGILS_DATA_KO: Sigil[] = [
  ...
  { 
    ...
    subOptions: [
      { id: 'lekolu_job_1', imageSrc: '/images/Dh3rP3K-lekolu1.webp', description: "몇 주 동안 신상품 하나를 열심히 팔아야 합니다. 언론 투어에 참가하거나, 마케팅 모델로 서거나, 필요하다면 광고도 찍어야겠죠. 상품이 대박을 쳐야만 보상을 받을 수 있기 때문에, 최선을 다해 사람들을 끌어모아 보세요!" },
      { id: 'lekolu_job_2', imageSrc: '/images/d0sX3Sq7-lekolu2.webp', description: "요즘 고예산 영화라고 하면 대기업들이 브랜드 이미지 제고를 위해 찍는 경우가 많습니다. 당신은 한 회사가 결국 세계를 구한다는 내용의 블록버스터 영화에 출연하기만 하면 됩니다. 연기하는 것도 꽤 재미있어요." },
      { id: 'lekolu_job_3', imageSrc: '/images/xtB6Ynf1-lekolu3.webp', description: "옛말에 틀린 건 없습니다. 유명한 건 그냥 좋은 거에요. 당신은 거물 기업가와 협력해서 커다란 스캔들 같은 걸 터뜨리게 될 겁니다! 사람들은 열받겠지만, 그걸 어떻게 교묘하게 조절하면 열받는데 미워할 수 없는 이미지 마케팅을 할 수 있죠." },
      { id: 'lekolu_job_4', imageSrc: '/images/qFLBx3v6-lekolu4.webp', description: "당신을 고용한 회사 측에서 경쟁 회사에 잠입해서 (사원으로 위장하든 그냥 은신해 들어가든) 기업 비밀을 빼 와 달라고 합니다! 산업 스파이는 물론 불법이지만, 뭐 누가 그 법을 무서워하나요. 제대로 미쳐 볼까요!" },
    ]
  },
  { 
    id: 'sinthru', 
    ...
    subOptions: [
      { id: 'sinthru_favor_1', imageSrc: '/images/WNpHjXvV-sinthru1.webp', description: "어머니의 신상 중 하나를 파괴해서 이 세계를 살피는 힘을 약화시켜야 합니다. 신상은 이 세계 곳곳에 있는 사원 안에 배치되어 엄중한 경비를 받고 있습니다. 은밀히 신상을 훔쳐 내거나, 수많은 마녀들과 맞서 싸워야 할 겁니다. 함정도 물론 조심해야 하구요!" },
      { id: 'sinthru_favor_2', imageSrc: '/images/xKDTS4fz-sinthru2.webp', description: "마녀단 단원들이 새로운 도시에 교단 은신처를 세우는 것을 도와야 합니다. 아주 신중하게 일을 처리해야겠죠. 치안대원들에게 뇌물을 주거나 속이고, 밀수 약물을 들여오고, 안전한 거점을 잡고, 혹시나 목격자가 생기면 모든 기억을 지워야 합니다." },
      { id: 'sinthru_favor_3', imageSrc: '/images/7xVHmzfT-sinthru3.webp', description: "전쟁 이전에 세워진 고대의 신스루 창고에 있는 함정을 피하는 법은 마녀단에서 알려 줄 겁니다. 그러면 당신이 그곳에 들어가 아직까지 남아 있는 지옥야수들을 처치하고 마녀단의 옛 장비들을 회수해 와야 합니다. 직접적인 방식을 선호하는 사람들에게는 안성맞춤이지요." },
      { id: 'sinthru_favor_4', imageSrc: '/images/G4X09cp8-sinthru4.webp', description: "마녀단에서 그들이 영혼을 포식할 수 있도록 다른 마법소녀를 죽이라고 합니다. 친구를 배신하겠습니까? 무고한 이를 습격하겠습니까? 선택은 당신의 몫입니다. 사실 그 쪽에서는 영혼의 순수성 같은 건 상관하지 않으니까요." },
    ]
  },
];
