...
export const SPECIAL_SIGILS_DATA: Sigil[] = [
  { 
    ...
    imageSrc: 'https://i.ibb.co/rfs5FtF3/xuth.png', 
  ...
  { 
    ...
    imageSrc: 'https://i.ibb.co/DD9xYmP9/lekolu.png', 
    ...
    subOptions: [
      { id: 'lekolu_job_1', imageSrc: 'https://i.ibb.co/Dh3rP3K/lekolu1.jpg', description: "Spend a few weeks hyping up a brand new product to make sure it succeeds. Participate in press tours, model in marketing photos, and even star in commercials. You'll only be fully rewarded if the product gets enough sales, so do your best to get people excited!" },
      { id: 'lekolu_job_2', imageSrc: 'https://i.ibb.co/d0sX3Sq7/lekolu2.jpg', description: "Pretty much every big-budget movie these days is made by a big company to improve their brand image. All you have to do is accept a role in one of these blockbuster films in which the corporation inevitably saves the day. At least acting is pretty fun." },
      { id: 'lekolu_job_3', imageSrc: 'https://i.ibb.co/xtB6Ynf1/lekolu3.jpg', description: "You know the old mantra: {i}all{/i} publicity is good publicity. You'll be working directly with a corporate celebrity to stir up some huge scandal or drama! Stir up outrage while running damage control to keep it in the goldilocks zone of outrageous yet forgivable." },
      { id: 'lekolu_job_4', imageSrc: 'https://i.ibb.co/qFLBx3v6/lekolu4.jpg', description: "Your employer wants you to infiltrate a rival company (either by posing as an employee, or through sheer stealthiness) and steal one of their trade secrets! Sure, corporate espionage is technically illegal, but it's not like that law is ever enforced. Go nuts!" },
    ]
  },
  { 
    id: 'sinthru', 
    ...
    imageSrc: 'https://i.ibb.co/nq80Y3pk/sinthru.png', 
    ...
    subOptions: [
      { id: 'sinthru_favor_1', imageSrc: 'https://i.ibb.co/WNpHjXvV/sinthru1.jpg', description: "You must destroy one of the Effigies of the Mother, weakening her ability to survey the realm. They are placed in heavily guarded temples all around the globe. Pull off a stealthy heist, or prepare for battle against multiple mages. Look out for booby traps!" },
      { id: 'sinthru_favor_2', imageSrc: 'https://i.ibb.co/xKDTS4fz/sinthru2.jpg', description: "You must help a few coven members get set up in a city they do not yet have a hideout in. This will be a game of discretion; bribing and fooling guards, smuggling in contraband reagents, securing a base, and wiping the memories of any witnesses." },
      { id: 'sinthru_favor_3', imageSrc: 'https://i.ibb.co/7xVHmzfT/sinthru3.png', description: "They'll tell you how to avoid every boobytrap in an old Sinthru stash from before the war, then, all you have to worry about is defeating the hellbeasts they left inside, and bringing them back their old gear. Definitely a good job for those who prefer to be more direct." },
      { id: 'sinthru_favor_4', imageSrc: 'https://i.ibb.co/G4X09cp8/sinthru4.png', description: "This task is simple: the covens ask that another mage be killed, so that they may gorge themselves upon their soul. Will you target a deserving fiend? Or ambush an unlucky innocent? The choice is yours, for it makes no difference to them whether the soul is pure." },
    ]
  },
];
