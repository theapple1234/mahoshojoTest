...
export const DRYADEA_DATA = {
    ...
    imageSrc: "/images/Y7cqGgf2-main5.webp",
...
export const DRYADEA_DATA_KO = {
    title: "안정의 여신 드리스데아",
    imageSrc: "/images/Y7cqGgf2-main5.webp",
    description: `아! 드디어 제 영역으로 찾아오셨군요! 제 힘은 자매들보다는 수수해 보이지만, 그래도 잠재력만큼은 뒤쳐지지 않는답니다. 제가 자매들 중 둘째라는 걸 믿으시겠어요? 그렇게 보이지는 않죠? 사실 마녀들이 수천 년 동안 살다 보면 IID에 걸릴 수밖에 없답니다. 불멸 촉발 우울증이죠. 하루하루가 몇 초 지나가듯이 흘러가고, 세계의 일들도 부질없는 다람쥐 쳇바퀴 같고, 그냥 다 지루해지죠. 그 때가 되면 다들 물러나는 건데... 저는 자매의 일원이니까 그럴 수는 없었구요. 그래서 전 수백 년마다 한 번씩 제 정신을 복사해 에테르에 업로드해 두고, 이 몸은... 기억을 대부분 지워 버리죠! 다시 태어나는 거랑 비슷해요. 사실 저랑 당신의 정신적 나이는 그렇게 많이 차이나지 않는답니다. 그래서 전 다른 자매들과는 달리 만물을 새로운 관점으로 바라볼 수도 있고, 마법소녀들과의 일대일 대면에 쏟을 에너지도 많아요. 마법소녀를 불쑥 찾아가서 그 얼굴에 웃음이 번지는 걸 보는 것보다 즐거운 게 없다니까요!

전 예전에는 자매들 중 가장 많은 축복과 마법을 관장했었죠. 마법소녀들이 새로운 아이디어를 들고 찾아오면 그걸 어떻게 거절할 수가 없어서 제 영역 밑으로 계속 넣었거든요. 그러다가 어머니께서 더 좋은 생각을 알려 주셨죠. 그냥 마법소녀들이 각자 새로운 마법을 창조할 수 있게 해 주는 거에요. 물론, 대부분의 마법소녀들은 이 귀중한 표식을 손에 넣을 수 없지만, 당신은 특별한 존재이니만큼 예외를 못 둘 것도 없죠...`
};

export const LIMITLESS_POTENTIAL_DATA = {
    title: "THE BLESSING OF LIMITLESS POTENTIAL",
    imageSrc: "/images/5gVcLdHy-main6.webp",
...
export const LIMITLESS_POTENTIAL_DATA_KO = {
    title: "무한한 잠재력의 축복",
    imageSrc: "/images/5gVcLdHy-main6.webp",
    description: `정말 흥미진진한 기회에요! 혹시 앞에서는 찾아볼 수 없었던 특별한 마법에 관한 아이디어가 있나요? 아니면 이미 있는 마법이지만 당신의 취향에 맞춰 살짝 개조해 보고 싶은가요? 당신이 이 초희귀 표식을 손에 넣었다는 걸 알면 다른 마법소녀들은 질투심에 배가 아파 데굴데굴 구를 거에요!

하지만, 새롭게 만든 마법은 이미 있는 마법처럼 "안정성 보장" 같은 건 없다는 걸 알려 드려야겠네요. 그만큼의 정제 작업을 거치지 않았으니까요. 제 경험상으로는 새로운 마법을 더욱 강력하게 만들려고 하면 시전자에게 역발사될 확률이 그만큼 올라가요. 특히 루하이 표식을 쓸 때는 더욱 그렇죠. 그러니까 대단한 마법 하나를 만들어서 온갖 싸움을 다 제패하려고 하기보다는 기존의 마법들을 활용하는 게 훨씬 신상에 좋을 거에요.`
};
...
export const CUSTOM_SPELL_RULES_DATA = {
    ...
    rules: [
        "Spells should have {i}counterplay{/i}. This means that almost every sort of build of Mage should have some way to adequately fight back against it. If it's particularly strong against one sort of build, it should be particularly weak against another.",
        "Spells should be {i}specific{/i}. You cannot bundle a wide array of powers into an 'all-in-one spell'. Every effect of the spell should be relevant to its premise.",
        ...
        "Note, though, that I lot tend to be particularly lenient towards spells I find especially creative or amusing!",
    ]
};

export const CUSTOM_SPELL_RULES_DATA_KO = {
    title: "새롭게 만드는 마법은 공정해야 합니다. 특히 다른 사람들이 당신의 마법을 보게 될 멀티플레이어라면 더욱 그렇죠. 다음 사항을 항상 주의하세요:",
    rules: [
        "마법에는 {i}카운터{/i}가 있어야 합니다. 즉, 어떤 마녀라도 당신의 마법에 대처할 수 있는 수단을 가지고 있어야 합니다. 만약 당신의 마법이 특정 마법에 강한 상성이라면, 다른 마법에는 약한 상성이어야 합니다.",
        "마법은 {i}구체적{/i}이어야 합니다. 두루뭉실한 '만능' 마법을 만들 수는 없습니다. 마법의 효과는 상위 분류와 맞아떨어져야 합니다.",
        "마법은 '메타'성이나 재귀성이 있어서는 안 됩니다. 즉, 다른 능력에 강화, 약화를 포함한 영향을 줘서는 안 되고, 루프의 반복을 통해 무한히 힘을 키운다거나 해서도 안 됩니다.",
        "시간 조작과 시간 여행은 금지됩니다.",
        "그래도, 저는 특별히 흥미롭거나 창의적인 마법이라면 꽤 괜찮게 받아들인다구요!",
    ]
};
...
export const LIMITLESS_POTENTIAL_RUNES_DATA: ChoiceItem[] = [
    {
        ...
        imageSrc: '/images/LzwcyY7z-ruhai.webp'
    },
    {
        id: 'mialgrath',
        title: 'MILGRATH',
        ...
        imageSrc: '/images/nsKwSt0b-mialgrath.webp'
    }
];

export const LIMITLESS_POTENTIAL_RUNES_DATA_KO: ChoiceItem[] = [
    {
        id: 'ruhai',
        title: '루하이',
        cost: '축복 점수 8점',
        description: "{c}루하이{/c} 표식은 기존의 분류에 해당하는 새로운 마법을 디자인할 수 있게 해 줍니다. 단, 그 분류에 해당하는 축복의 {j}자타스{/j} 표식을 가지고 있어야 합니다. 예를 들면, 물체의 온도를 변화시키는 마법이라면 {i}메타열역학{/i} 분류에 포함될 것이고, 조작자 표식을 가지고 있어야 합니다. 여러 분류에 걸치는 마법은 디자인할 수 없습니다. 가령 염동력으로 체내 세포를 변화시키는 마법을 만들 수는 없습니다. 염력과 변신술이라는 두 분류에 해당하니까요. 또한, {i}메타마법{/i}이나 동료, 동물, 탈것, 무기를 창조하는 마법은 디자인할 수 없습니다. 시간 조작도 안 됩니다. 너무 사기거든요. 새롭게 만들어진 마법은 {w}카른{/w}이나 낮은 {g}퍼르스{/g} 등급이어야 합니다.",
        imageSrc: '/images/LzwcyY7z-ruhai.webp'
    },
    {
        id: 'mialgrath',
        title: '밀그라스',
        cost: '축복 점수 16점',
        description: "{b}밀그라스{/b} 표식은 위에 명시된 제한 사항 {i}한 가지{/i}만을 무시할 수 있게 해 줍니다. 분류 제한을 무시할 수도 있고, 분류 제한이 걸린 상태에서 마법의 위력을 강화시킬 수도 있습니다. 물론 '승리 치트키' 마법을 만들 수는 없습니다. {i}메타마법{/i}이나 시간 조작은 여전히 건드릴 수 없지만, 동료, 동물, 탈것이나 무기의 창조는 가능합니다. {i}참고 페이지{/i}의 디자인에 투자할 점수 {w}100점{/w}이 주어지고, 특별히 표기되지 않은 당신만의 디자인도 가능합니다. 새롭게 만들어진 마법은 상위 {g}퍼르스{/g} 등급이거나 {r}주스{/r} 등급이어야 합니다. (후자라면 여전히 {w}시련{/w}을 통과해야 합니다.)",
        imageSrc: '/images/nsKwSt0b-mialgrath.webp'
    }
];
